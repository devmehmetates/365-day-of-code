...
| ---- | ------ | --- | ------- | ----------------- | ---------------- |
| Socia | Stopped(For little surprise) |  <a href="https://github.com/devmehmetates/Socia">Go to Project</a> | Social Media | SwiftUI, UIKit integration, Firebase | MVVM, WebKit, UIImagePicker, Auth-System, EnvironmentObjects, ObservedObjects, UserDefaults, Video-Player, Pure iOS Properties, Unit Tests, AVFoundation |
